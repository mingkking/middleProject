...
<title>questionAnswer.jsp</title>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-6 text-center">
						<h2 data-aos="fade-down">문의 답변</h2>
						<form method="post" action='getQuestion'>
							<div class="row gy-4">
								...
								<div class="col-md-8">
									<input type="date" name="qRegdate" class="form-control" 
									 style="background-color:transparent; border-style:none; color:white" value='${question.qRegdate }' readonly>
								</div>
								...
								<div class="col-md-8">
									<input type="text" class="form-control" name="qWriter" value='${question.qTitle }'
									 style="background-color:transparent; border-style:none; color:white" required readonly/>
								</div>
								...
								<div class="col-md-8">
									<input type="text" class="form-control" name="qTitle" value='${question.qTitle }'
									 style="background-color:transparent; border-style:none; color:white" required readonly/>
								</div>
                            ...
                            <div class="col-md-8">
                                <textarea name="qContent" class="form-control" rows="5" 
                                style="background-color:transparent; border-style:none; color:white" required readonly>${question.qContent }</textarea>
                            </div>
                            ...
                            <div class="col-md-4">
								...
								<div class="col-md-8">
									<input type="text" name="qTitle" class="form-control" placeholder="제목을 입력해주세요." value='${question.qTitle }'>
								</div>
								...
								<div class="col-md-8">
									<input type="text" class="form-control" name="qAnswer" placeholder="답변내용을 입력해주세요." value='${question.qAnswer }' required/>
								</div>
