	...
	<section id="hero" class="hero">
		...
		<div id="hero-carousel" class="carousel slide" data-bs-ride="carousel"
			...
			<div class="carousel-item active"
				style="background-image: url(${path}/resources/assets/img/hero-carousel/o5.jpg)"></div>
			<div class="carousel-item"
				style="background-image: url(${path}/resources/assets/img/hero-carousel/o1.jpg)"></div>
			<div class="carousel-item"
				style="background-image: url(${path}/resources/assets/img/hero-carousel/o2.jpg)"></div>
			<div class="carousel-item"
				style="background-image: url(${path}/resources/assets/img/hero-carousel/o3.jpg)"></div>
			<div class="carousel-item"
				style="background-image: url(${path}/resources/assets/img/hero-carousel/o4.jpg)"></div>
				...
				<div class="row justify-content-between gy-4">
					...
					<div class="col-lg-5" data-aos="fade">
						<form action="forms/quote.php" method="post"
							...
							<h3>Get a quote</h3>
							<p>Vel nobis odio laboriosam et hic voluptatem. Inventore
								vitae totam. Rerum repellendus enim linead sero park flows.</p>
							<div class="row gy-3">
								...
								<div class="col-md-12 text-center">
									...
									<div class="sent-message">Your quote request has been
