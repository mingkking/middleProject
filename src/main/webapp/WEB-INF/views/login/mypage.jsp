	...
	$(function() {
		...
		$('#cancelMember').click(
				function() {
					...
					if ($('#nowPassword').val() == null
							|| $('#nowPassword').val() == "") {
						alert('현재 비밀번호를 입력해주세요');
					} else {
						location.href = 'deleteMypage?id=' + $('#nowId').val()
								+ '&password=' + $('#nowPassword').val()
								+ '&name=' + $('#nowName').val() + '&tel='
								+ $('#nowTel').val() + '&email='
								+ $('#nowEmail').val() + '&birth='
								+ $('#nowBirth').val();
					}
					...
					<div class="col-lg-6 text-center">
						...
						<form action="updateMypage" method="post" id="updateMypage">
							<div class="row gy-4">
								...
								<div class="col-md-5">
									<input type="text" id="nowName" name="name"
										class="form-control" value="${vo.name }" />
								</div>
								...
								<div class="col-md-8">
									<input type="date" id="nowBirth" name="birth"
										class="form-control" value="${vo.birth }" />
								</div>
								...
								<div class="col-md-8">
									<input type="password" class="form-control" name="password1"
										id="password1" placeholder="소문자, 숫자, 7~14자리" />
								</div>
								...
								<div class="col-md-8">
									<input type="password" class="form-control" name="password2"
										id="password2" placeholder="소문자, 숫자, 7~14자리" />
								</div>

								<div class="col-md-4" id='modifyunregisterBtn'></div>
								<div class="col-md-4 text-center">
									<input type="button" id="cancelMember" value="회원탈퇴"
										class="unregisterBtn" />
